use crate::assembly::amd64::{AMD64Operand, AMD64Register, MemorySize};
...
impl AMD64Instruction {
    ...
    pub(crate) fn bytes_8(imm: i32) -> Vec<u8> {
        Vec::from((imm as u8).to_le_bytes())
    }

    pub(crate) fn bytes_16(imm: i32) -> Vec<u8> {
        Vec::from((imm as u16).to_le_bytes())
    }

    pub(crate) fn bytes_32(imm: i32) -> Vec<u8> {
